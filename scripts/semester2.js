const subjects = [
    ...
    { href: "/notes/CSE/subjects2/AM2.html", name: "Applied Mathematics-II" },
    { href: "/notes/CSE/subjects2/AP2.html", name: "Applied Physics-II" },
...
const subjectsContainer = document.getElementById('subjects2');
